...
public class mod_MainClass{
  @SidedProxy(clientSide = "warloc.ClientProxy", serverSide = "warloc.ServerProxy")
	 ...
	 * */
	static int EntityCreeperManId = 2000;//Айди яйца тестового моба, человека крипера.
	...
	public void load(FMLPreInitializationEvent event) {
		...
		/* Файл конфигурации
		 * при задании Ид предметам через него происходит ошибка генерации биома 
		 * так как айди null 
		 * (возможное решение есть в extrabiomes) 
		 * */
		/*
